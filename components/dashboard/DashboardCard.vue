<template>
  ...
  <v-card class="flex-fill d-flex align-start" style="height: 100%">
      ...
      <div class="flex-fill flex-row d-flex align-start">
        ...
        <div style="width: 100%">
          <v-card-title class="pb-0 text-no-wrap">
            ...
            <small class="font-italic font-weight-regular caption" v-if="cardData.valueDetails"
                   v-html="cardData.valueDetails"></small>
          </v-card-title>
          ...
          <v-card-actions class="text-right pt-0 transparent"
            ...
            <v-btn link text small color="primary" @click="cardData.action"
                   :disabled="cardData.actionDisabled">
              {{ cardData.actionText }}
            </v-btn>
          </v-card-actions>
        </div>
