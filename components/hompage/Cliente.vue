<template>
  <div>
    ...
    <dashboard-blocks v-if="dashboardData.blocks" :dashboard-data="dashboardData" :loading="loading"></dashboard-blocks>

    <v-row class="my-5">
      <v-col sm="12" md="8">
        <v-card class="text-center">
          <v-card-text v-if="dashboardData.charts">
            <chart-lines
...
export default {
  ...
  setup (props, { root }) {
    ...
    const chartsClientLabels = computed(() => {
      return dashboardData.charts ? clientDashboardChart.labels(
