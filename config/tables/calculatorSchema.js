export default {
  'date': {text: 'tables.calc-date', value: 'date', align: "right", width: "15%", sortable: false},
  ...
  'interestCollected': {text: 'tables.calc-interest-collected', value: 'interestCollected', align: "right", sortable: false},
